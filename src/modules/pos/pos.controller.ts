...
export class PosController {
    ...
    async createSale(@Req() req: any, @Body() body: { items: { productId: string; quantity: number }[]; sellerId: string; customerId?: string }) {
    ...
    async completeSale(@Param('id') id: string, @Body() body: { paymentMethod: PaymentMethodPOS; cashReceived: number; notes?: string }) {
    ...
    async getSales(@Query('status') status?: string, @Query('startDate') startDate?: string, @Query('endDate') endDate?: string) {
