...
export class AccountingController {
  ...
  async reconcileBank(
    @Param('id') id: string,
    @Body() body: { journalEntryIds: string[] },
  ) {
  ...
  async getReconciliationReport(
    ...
    return this.accountingService.getReconciliationReport(
      bankAccountId,
      startDate,
      endDate,
    );
  ...
  async getBudgetVsExecution(@Query('year') year: number) {
    return this.accountingService.getBudgetVsExecution(
      year || new Date().getFullYear(),
    );
  }
  ...
  async approveRequest(
    ...
    return this.accountingService.approveRequest(
      id,
      body.approverId,
      body.notes,
    );
  ...
  async rejectRequest(
    ...
    return this.accountingService.rejectRequest(
      id,
      body.approverId,
      body.reason,
    );
  ...
  async getNIIFBalanceSheet(@Query('date') date: string) {
    return this.accountingService.getNIIFBalanceSheet(
