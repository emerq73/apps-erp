...
export class InventoryController {
    constructor(
        ...
        @InjectRepository(InventoryMovementItem) private itemRepo: Repository<InventoryMovementItem>,
    ...
    private async createAccountingEntry(movement: InventoryMovement, item: any) {
        try {
            ...
            } else if (movement.type === MovementType.OUT && inventoryAccount && cogsAccount) {
                await this.accountingService.createEntry(
                    cogsAccount.id,
                    inventoryAccount.id,
                    totalCost,
